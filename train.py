...
@click.option('--val-dataset', type=click.Choice(datasets.keys()), default='sbdd')
@click.option('--val-split', type=str, default='val')
@click.option('--class-group', type=click.Choice(['all', '0', '1', '2', '3']), default='all')
...
@click.option('--max-iter', type=int, default=int(1e5))
